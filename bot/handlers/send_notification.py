    ...
    for region in REGIONS:
        ...
        if prayer_time.status_code == 200:
            try:
                ...
                print(f"[ERROR_TELEGRAM_BOT] API Error: {exc}")
...
async def peshin_region1():
    for user in get_user_filter_by_region(region="Toshkent"):
        if user['notification']:
            try:
                await bot.send_message(chat_id=int(user['id']), text=f"<b>Peshin namozi vaqti bo'ldi ⏰</b>\n\n<i>📍 Shahar (viloyat): {user['region']}\n✏️ Shaharni o'zgartirish uchun Sozlamalar qismiga kiring ⚙️</i>",
                    reply_markup=notification_btn)
            except:
                pass
...
async def asr_region1():
    for user in get_user_filter_by_region(region="Toshkent"):
        if user['notification']:
            try:
                await bot.send_message(chat_id=int(user['id']), text=f"<b>Asr namozi vaqti bo'ldi ⏰</b>\n\n<i>📍 Shahar (viloyat): {user['region']}\n✏️ Shaharni o'zgartirish uchun Sozlamalar qismiga kiring ⚙️</i>",
                    reply_markup=notification_btn)
            except:
                pass
...
async def shom_region1():
    for user in get_user_filter_by_region(region="Toshkent"):
        if user['notification']:
            try:
                await bot.send_message(chat_id=int(user['id']), text=f"<b>Shom namozi vaqti bo'ldi ⏰</b>\n\n<i>📍 Shahar (viloyat): {user['region']}\n✏️ Shaharni o'zgartirish uchun Sozlamalar qismiga kiring ⚙️</i>",
                    reply_markup=notification_btn)
            except:
                pass
...
async def hufton_region1():
    for user in get_user_filter_by_region(region="Toshkent"):
        if user['notification']:
            try:
                await bot.send_message(chat_id=int(user['id']), text=f"<b>Hufton namozi vaqti bo'ldi ⏰</b>\n\n<i>📍 Shahar (viloyat): {user['region']}\n✏️ Shaharni o'zgartirish uchun Sozlamalar qismiga kiring ⚙️</i>",
                    reply_markup=notification_btn)
            except:
                pass
